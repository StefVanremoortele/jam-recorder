...
class Stream_Analyzer:
    ...
    def __init__(self,
        ...
        try:
            from core.stream_reader_pyaudio import Stream_Reader
            ...
            from core.stream_reader_sounddevice import Stream_Reader
            self.stream_reader = Stream_Reader(
                device  = device,
                rate    = rate,
                updates_per_second  = updates_per_second,
        ...
        if self.visualize:
            from core.visualizer import Spectrum_Visualizer
        ...
        if self.visualize:
            self.visualizer = Spectrum_Visualizer(self, controller)
    ...
    def quit(self):
        self.visualizer.toggle_display()