...
class Spectrum_Visualizer:
    ...
    """
    def __init__(self, ear, controller):
    ...
    def start(self):
        ...
        pygame.draw.circle(self.screen, (20,15,100), (200, 200), 50, 10) #(r, g, b) is color, (x, y) is center, R is radius and w is the thickness of the circle border.
        for i in range(self.ear.n_frequency_bins):
    ...
    def update(self):
        ...
        if self.controller.last_noise:
            pygame.draw.circle(self.screen, (200,15,50), (130, 25), 10) #(r, g, b) is color, (x, y) is center, R is radius and w is the thickness of the circle border.
        else:
            pygame.draw.circle(self.screen, (50,205,50), (130, 25), 10) #(r, g, b) is color, (x, y) is center, R is radius and w is the thickness of the circle border.
        pygame.display.flip()
